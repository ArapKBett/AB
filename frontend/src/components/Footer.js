    ...
    <footer className="py-6 bg-gray-800 text-gray-400">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center space-y-4 md:flex-row md:justify-between">
        ...
        <div className="flex space-x-6">
          <a href="https://github.com/your-github-username" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-cyan-400 transition-colors">
          ...
          <a href="https://twitter.com/your-x-username" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-cyan-400 transition-colors">
          ...
          <a href="https://discord.com/users/your-discord-id" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-cyan-400 transition-colors">
            <FaDiscord className="mr-2" /> Discord
          </a>
          <a href="weixin://dl/chat?your-wechat-id" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-cyan-400 transition-colors">
