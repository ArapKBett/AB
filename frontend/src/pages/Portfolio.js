    ...
    <section className="py-20 max-w-6xl mx-auto px-4 pt-20">
      <div className="mb-20">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          I’m a Web Developer and Cybersecurity Specialist crafting secure, responsive web applications, sofwares and systems. I’ve led teams and reduced vulnerabilities with cutting-edge security audits.
        </p>
      </div>
      ...
      <div className="mb-20 bg-gray-800 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
          {[
            { title: 'Languages', items: ['HTML', 'JavaScript', 'CSS', 'Python', 'C', 'C++', 'SQL', 'Java', 'Kotlin', 'Angular'] },
      ...
      <div className="mb-20">
        ...
        <div className="space-y-8">
          {[
            { role: 'Lead Consultant, Teaburg International', time: 'March 2022 - Present', tasks: ['Reduced vulnerabilities by 80%', 'Implemented firewalls', 'Continuos Improvement'] },
