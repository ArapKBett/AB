...
const Portfolio = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/projects') // Update URL
    ...
    <section className="py-20 max-w-6xl mx-auto px-4 pt-20">
      <div className="mb-20">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          I’m a Developer and Cybersecurity Specialist crafting secure, responsive web applications and Software. I’ve led teams and reduced vulnerabilities with cutting-edge security audits.
        </p>
      </div>
      ...
      <div className="mb-20 bg-gray-800 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
          {[
            { title: 'Languages', items: ['HTML', 'JavaScript', 'Node.js', 'React', 'Tailwind', 'C', 'C++', 'Java', 'Python', 'Kotlin', 'SQL', 'Angular'] },
      ...
      <div className="mb-20">
        ...
        <div className="space-y-8">
          {[
            { role: 'Lead Consultant, Teaburg International', time: 'March 2022 - Present', tasks: ['Reduced vulnerabilities by 80%', 'Implemented firewalls', 'Continous improvements'] },
